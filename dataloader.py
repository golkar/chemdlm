...
def get_dataset(
    ...
    if dataset_name == "wikitext103":
        ...
        dataset = load_selfies_dataset(
            file_path="/mnt/home/sgolkar/ceph/datasets/chemdlm/coconut.sf",
            cache_dir=cache_dir,
            streaming=streaming,
        )
    elif dataset_name == "coconut_train":
        dataset = load_selfies_dataset(
            file_path="/mnt/home/sgolkar/ceph/datasets/chemdlm/coconut_train.sf",
            cache_dir=cache_dir,
            streaming=streaming,
        )
    elif dataset_name == "coconut_val":
        dataset = load_selfies_dataset(
            file_path="/mnt/home/sgolkar/ceph/datasets/chemdlm/coconut_val.sf",
            cache_dir=cache_dir,
            streaming=streaming,
        )
    else:
